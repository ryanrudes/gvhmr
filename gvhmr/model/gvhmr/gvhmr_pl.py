...
from gvhmr.model.gvhmr.utils.postprocess import pp_static_joint, process_ik
...
from gvhmr.utils.vis.cv2_utils import draw_bbx_xys_on_image_batch
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        if False:  # wis3d
            ...
            for i in range(len(smplx_out.vertices)):
                ...
                wis3d.add_mesh(smplx_out.vertices[i], smplx_model.bm.faces, name="pred-smplx-global")
            ...
            for i in range(len(smplx_verts_ayfz)):
                wis3d.set_scene_id(i)
                wis3d.add_mesh(smplx_verts_ayfz[i], smplx_models[gender].bm.faces, name="gt-smplx-ayfz")
