...
from gvhmr.utils.vis.cv2_utils import cv2, draw_bbx_xys_on_image_batch, draw_coco17_skeleton_batch
...
class MetricMocap(pl.Callback):
    def __init__(self):
        ...
        self.J_regressor = torch.load("gvhmr/utils/body_model/smpl_3dpw14_J_regressor_sparse.pt").to_dense()
        self.J_regressor24 = torch.load("gvhmr/utils/body_model/smpl_neutral_J_regressor.pt")
