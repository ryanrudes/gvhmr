...
from gvhmr.utils.video_io_utils import get_writer, read_video_np
from gvhmr.utils.vis.renderer import Renderer, get_global_cameras_static, get_ground_params_from_points
...
class MetricMocap(pl.Callback):
    def __init__(self):
        ...
        self.J_regressor = torch.load("gvhmr/utils/body_model/smpl_neutral_J_regressor.pt")
        self.smplx2smpl = torch.load("gvhmr/utils/body_model/smplx2smpl_sparse.pt")
    ...
    def on_predict_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx=0):
        ...
        if False:  # incam visualize debug
            ...
            for i in track(range(seq_length), desc=f"Rendering {vname}"):
