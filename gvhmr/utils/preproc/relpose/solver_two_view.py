...
class PycolmapRansacTwoViewGeometrySolver:
    ...
    def solve(self, pts0, pts1):
        ...
        # cam2_from_cam1 means T_0_to_1 in our language. pycolmap returns None when the
        # two-view geometry is degenerate / has too few inliers for this pair; signal that to
        # the caller (which carries forward the last valid motion rather than freezing).
