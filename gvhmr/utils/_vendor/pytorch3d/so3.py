...
from . import rotation_conversions  # [GVHMR vendor patch] was: from pytorch3d.transforms import rotation_conversions
from .math import (
    acos_linear_extrapolation,  # [GVHMR vendor patch] was: from ..transforms import acos_linear_extrapolation
)
