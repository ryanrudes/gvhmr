...
# [GVHMR vendor patch] inlined from pytorch3d.common.datatypes to drop the pytorch3d dependency
...
def random_quaternions(n: int, dtype: torch.dtype | None = None, device: Device | None = None) -> torch.Tensor:
    """
...
def random_rotations(n: int, dtype: torch.dtype | None = None, device: Device | None = None) -> torch.Tensor:
    """
...
def random_rotation(dtype: torch.dtype | None = None, device: Device | None = None) -> torch.Tensor:
    """
