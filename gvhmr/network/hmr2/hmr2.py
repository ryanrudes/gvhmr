...
# [GVHMR vendor patch] was: from pytorch3d.transforms import matrix_to_axis_angle
# (re-exported, byte-identical, from the vendored copy so the feature path needs no pytorch3d)
from gvhmr.utils.geo.rotations import matrix_to_axis_angle
from gvhmr.utils.geo.hmr_cam import compute_transl_full_cam
