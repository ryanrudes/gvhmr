...
from gvhmr.network.base_arch.transformer.encoder_rope import EncoderRoPEBlock
from gvhmr.network.base_arch.transformer.layer import zero_module
from gvhmr.utils.net_utils import length_to_mask
...
class NetworkEncoderRoPE(nn.Module):
    ...
    def _build_condition_embedder(self) -> None:
    ...
    def forward(
        ...
        f_cliffcam: torch.Tensor | None = None,
        f_cam_angvel: torch.Tensor | None = None,
        f_imgseq: torch.Tensor | None = None,
