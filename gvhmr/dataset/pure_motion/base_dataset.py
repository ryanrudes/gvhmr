...
from gvhmr.utils.geo.hmr_cam import create_camera_sensor
...
from gvhmr.utils.wis3d_utils import add_motion_as_lines, convert_motion_as_line_mesh, make_wis3d
    ...
    def _process_data(self, data, idx):
        ...
        if False:  # render
            for idx_render in range(10):
                ...
                for i in track(range(len(verts)), desc=f"Rendering {vname}"):
                    # incam
